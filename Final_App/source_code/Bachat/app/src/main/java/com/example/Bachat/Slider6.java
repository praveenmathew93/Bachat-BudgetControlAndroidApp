...
public class Slider6 extends AppCompatActivity {
    ...
    private void setupOnboardingItems() {
        ...
        itemOntheway.setTitle("Now swipe right to repeat a transaction");
        itemOntheway.setDescription("");
        itemOntheway.setImage(R.drawable.repeatoptionscreen);
