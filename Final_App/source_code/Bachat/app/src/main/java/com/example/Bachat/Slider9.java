...
public class Slider9 extends AppCompatActivity {
    ...
    private void setupOnboardingItems() {
        ...
        itemPayOnline.setTitle("Go to history option from your home screen");
        itemPayOnline.setDescription("");
        itemPayOnline.setImage(R.drawable.homescreen);

        OnboardingItem itemPayOnline1 = new OnboardingItem();
        itemPayOnline1.setTitle("Click on an individual transaction to edit them ");
        itemPayOnline1.setDescription("");
        itemPayOnline1.setImage(R.drawable.transactionhistroyscreen);

        OnboardingItem itemPayOnline2 = new OnboardingItem();
        itemPayOnline2.setTitle("Now you can easily edit your transaction");
        itemPayOnline2.setDescription("");
        itemPayOnline2.setImage(R.drawable.updateexpense);
