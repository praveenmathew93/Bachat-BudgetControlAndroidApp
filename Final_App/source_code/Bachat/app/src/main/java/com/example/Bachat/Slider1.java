...
public class Slider1 extends AppCompatActivity {
    ...
    private void setupOnboardingItems() {
        ...
        itemPayOnline.setTitle("Click on the add expense/income button");
        itemPayOnline.setDescription("");
        itemPayOnline.setImage(R.drawable.addexpenseincomebutton);


        OnboardingItem itemOntheway = new OnboardingItem();
        itemOntheway.setTitle("Now choose your desired category");
        itemOntheway.setDescription("");
        itemOntheway.setImage(R.drawable.categoryscreen);

        OnboardingItem itemEatTogether = new OnboardingItem();
        itemEatTogether.setTitle("Choose a subcategory");
        itemEatTogether.setDescription("or add new ones");
        itemEatTogether.setImage(R.drawable.subcategoryscreen);

        OnboardingItem itemOntheway11 = new OnboardingItem();
        itemOntheway11.setTitle("Select date, amount and currency");
        itemOntheway11.setDescription("Add notes or even attach a contact");
        itemOntheway11.setImage(R.drawable.addingexpensescreen);
