...
public class ShowAllAdapterList extends ArrayAdapter<ListItem> {
   ...
   /* public ViewAllAdapter(View.OnClickListener onClickListener, int resource, ArrayList<ListItem> objects) {
    ...
    public ShowAllAdapterList(Context context, int resource, ArrayList<ListItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //ViewHolder object
        ShowAllAdapterList.ViewHolder holder;

        if(convertView == null){
            LayoutInflater inflater = LayoutInflater.from(mContext);
            convertView = inflater.inflate(mResource, parent, false);
            holder= new ShowAllAdapterList.ViewHolder();
            ...
            holder = (ShowAllAdapterList.ViewHolder) convertView.getTag();
            result = convertView;
        }
