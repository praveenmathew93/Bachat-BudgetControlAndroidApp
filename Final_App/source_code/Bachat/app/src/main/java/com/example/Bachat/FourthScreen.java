...
public class FourthScreen extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        setTheme(getCustomTheme(getIntent().getStringExtra("fromThird_Category")));

        super.onCreate(savedInstanceState);
        setContentView(R.layout.fourth_screen);
        myDb = new DatabaseHelper(this);
        Log.d(TAG, "onCreate: Background" + getIntent().getStringExtra("fromThird_Category"));


        editText = findViewById(R.id.Date);
        Drawable drawable = getDrawable(R.drawable.ic_calendar);
        drawable = DrawableCompat.wrap(drawable);
        DrawableCompat.setTint(drawable, getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        ...
        editText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // TODO Auto-generated method stub
                new DatePickerDialog(FourthScreen.this,getCustomDateTheme(getIntent().getStringExtra("fromThird_Category")),date, myCalendar
        ...
        noteHelp.setBackgroundColor(getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        ...
        addnote.setTextColor(getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));

        editnote = (EditText) findViewById(R.id.editTextNote2);
        editnote.setHint("Add a note...");
        ...
        modeSpinner.getBackground().setColorFilter(getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()), PorterDuff.Mode.SRC_ATOP);
        ...
        DrawableCompat.setTint(drawable_mop, getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        ...
        DrawableCompat.setTint(drawable_add_con, getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        ...
        Drawable drawable_name = getDrawable(R.drawable.ic_person_name);
        drawable_name = DrawableCompat.wrap(drawable_name);
        DrawableCompat.setTint(drawable_name, getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        DrawableCompat.setTintMode(drawable_name, PorterDuff.Mode.SRC_IN);

        Drawable drawable_email = getDrawable(R.drawable.ic_email);
        drawable_email = DrawableCompat.wrap(drawable_email);
        DrawableCompat.setTint(drawable_email, getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        DrawableCompat.setTintMode(drawable_email, PorterDuff.Mode.SRC_IN);


        Drawable drawable_phone = getDrawable(R.drawable.ic_phone);
        drawable_phone = DrawableCompat.wrap(drawable_phone);
        DrawableCompat.setTint(drawable_phone, getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        DrawableCompat.setTintMode(drawable_phone, PorterDuff.Mode.SRC_IN);
        ...
        DrawableCompat.setTint(drawable_added, getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        ...
        addedContact.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                //dialog.getContext().setBackgroundDrawable(new ColorDrawable(Color.TRANSPARENT));
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (amountcheck.length() == 0) {
                    ...
                    if(!curr.equals(HomeFragment.default_currency)){
                        Toast.makeText(FourthScreen.this, "Please enter amount before selecting a currency", Toast.LENGTH_SHORT).show();
                    }
                    ...
                    if(!currSelected.equals(HomeFragment.default_currency)){
                        ...
                        try {
                            ...
                            if (check) {
                                ...
                                Toast.makeText(FourthScreen.this, "No network connection. Using offline rate of 1 " + HomeFragment.default_currency + " = " + Double.parseDouble(rate) + " " + currSelected, Toast.LENGTH_LONG).show();
        ...
        final EditText editnote = (EditText) findViewById(R.id.editTextNote2);
        editnote.setImeOptions(EditorInfo.IME_ACTION_NEXT);
        editnote.setRawInputType(InputType.TYPE_CLASS_TEXT);
        setEditTextCursorColor(editnote,getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        Drawable drawable_note = getDrawable(R.drawable.ic_note);
        drawable_note = DrawableCompat.wrap(drawable_note);
        DrawableCompat.setTint(drawable_note, getResources().getColor(getColor(getIntent().getStringExtra("fromThird_Category")),getTheme()));
        ...
        ColorStateList fabBackgroundTint = getColorStateList(getColor(getIntent().getStringExtra("fromThird_Category")));

        Log.d(TAG, "onCreate: "+ fabBackgroundTint.getDefaultColor());

        addButton.setBackgroundTintList(ContextCompat.getColorStateList(getApplicationContext(),getColor(getIntent().getStringExtra("fromThird_Category"))));
        ...
        String fromThird_1 = getIntent().getStringExtra("fromThird");
        String sub[] = fromThird_1.split(",");

        subTitle = findViewById(R.id.toolbar_sub_title);
        subTitle.setText(sub[0]);
                ...
                FourthScreen.this.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            Log.d("converting amount", ": " + baseValue +
                                    " from : " + baseCurr + " to user's default currency , which is : " +toCurr);
