...
public class Slider7 extends AppCompatActivity {
    ...
    private void setupOnboardingItems() {
        ...
        itemPayOnline.setTitle("Click on the profile option on the top left of home screen");
        itemPayOnline.setDescription("");
        itemPayOnline.setImage(R.drawable.addexpenseincomebutton);


        OnboardingItem itemOntheway = new OnboardingItem();
        itemOntheway.setTitle("Here you can add multiple profiles");
        itemOntheway.setDescription("");
        itemOntheway.setImage(R.drawable.profileadded);

        OnboardingItem itemOntheway1 = new OnboardingItem();
        itemOntheway1.setTitle("You can also delete a profile by swiping left");
        itemOntheway1.setDescription("");
        itemOntheway1.setImage(R.drawable.deletingprofile);
