...
public class Slider5 extends AppCompatActivity {
    ...
    private void setupOnboardingItems() {
        ...
        itemPayOnline.setTitle("Go to history from home page");
        itemPayOnline.setDescription("View your expenses and earnings");
        itemPayOnline.setImage(R.drawable.homescreen);


        OnboardingItem itemOntheway = new OnboardingItem();
        itemOntheway.setTitle("Now swipe left to delete a transaction");
        itemOntheway.setDescription("");
        itemOntheway.setImage(R.drawable.deleteoptionscreen);
