...
public class Slider3 extends AppCompatActivity {
    ...
    private void setupOnboardingItems() {
        ...
        itemPayOnline.setDescription("and click on the export option");
        itemPayOnline.setImage(R.drawable.exportscreen1);


        OnboardingItem itemOntheway = new OnboardingItem();
        itemOntheway.setTitle("Now can export you expenses and incomes");
        itemOntheway.setDescription("click on the income or expense button to export data");
        itemOntheway.setImage(R.drawable.exportoptionscreen);
