...
public class Slider11 extends AppCompatActivity {
    ...
    private void setupOnboardingItems() {
        ...
        itemPayOnline.setTitle("This is slider 11");
        itemPayOnline.setDescription("Track your expenses and make smart decisions");
        itemPayOnline.setImage(R.drawable.add_expense);
        ...
        itemOntheway.setImage(R.drawable.ic_launcher_background);
        ...
        itemEatTogether.setImage(R.drawable.onboarding_indicator_inactive);
        ...
        itemOntheway11.setImage(R.drawable.onboarding_indicator_inactive);


        OnboardingItem itemOntheway1 = new OnboardingItem();
        itemOntheway1.setTitle("NEW ");
        itemOntheway1.setDescription("5th screen ");
        itemOntheway1.setImage(R.drawable.onboarding_indicator_inactive);
